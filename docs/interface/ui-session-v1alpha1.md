...
200 ([UISessionList](../interface/ui-session-v1alpha1#UISessionList)): OK
...
- **body**: [UISession](../interface/ui-session-v1alpha1#UISession), required
...
202 ([UISession](../interface/ui-session-v1alpha1#UISession)): Accepted
